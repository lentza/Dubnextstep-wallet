...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wall -Wliteral-suffix -Wformat-extra-args
...
macx:ICON = src/qt/res/icons/DubNextStep.icns
macx:TARGET = "DubNextStep-Qt"
