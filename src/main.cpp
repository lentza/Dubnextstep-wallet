...
int64 nChainStartTime = 1391393693;
...
const string strMessageMagic = "DubNextStep Signed Message:\n";
...
static const int CUTOFF_HEIGHT = 50080;	// Height at the end of block 50079
// miner's coin base reward based on nBits
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	int64 nSubsidy = 50000 * COIN; //Giveaways, dump prevention, early distribution
	...
	// Subsidy is cut in half every week or 10160 blocks, which will occur approximately every month
	nSubsidy >>= (nHeight / 10160); 
    return nSubsidy + nFees;
}
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in DubNextStep
    bool fStrictPayToScriptHash = true; // Always active in DubNextStep
    ...
    // ppcoin: track money supply and mix amount info
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DubNextStep", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Music and crypto crossover";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xfdf4c5794bc2deee74045393860ebc9aa7a74a40c909d01921e96fe0b38248d2"));
...
void PrintBlockTree()
{
    ...
    while (!vStack.empty())
    {
        ...
        printf("%d (%u,%u) %s  %08x  %s  mix %7s  tx %"PRIszu"",
            pindex->nHeight,
            pindex->nFile,
            pindex->nBlockPos,
            block.GetHash().ToString().c_str(),
