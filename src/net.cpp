...
bool GetMyExternalIP(CNetAddr& ipRet)
{
    ...
    for (int nHost = 1; nHost <= 2; nHost++)
    {
        ...
        if (nHost == 1)
        {
            addrConnect = CService("52.53.202.239",80); // checkip.dyndns.org
        ...
        {
            addrConnect = CService("52.8.44.62", 80); // www.showmyip.com
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DubNextStep " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed.DubNextStepofficial.com", "seed.DubNextStepofficial.com"},
    {"mintseed.DubNextStepfund.org", "mintseed.DubNextStepfund.org"},
    {"mintseed.keremhd.name.tr", "mintseed.keremhd.name.tr"},
    {"mix.seed.fuzzbawls.pw", "mix.seed.fuzzbawls.pw"},
    {"", ""},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DubNextStep is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    // ppcoin: mix proof-of-stake blocks in the background
