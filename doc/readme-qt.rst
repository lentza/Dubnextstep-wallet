DubNextStep-Qt: Qt5 GUI for DubNextStep
=================================
...
Alternatively, install Qt Creator and open the `DubNextStep-qt.pro` file.

An executable named `DubNextStep-qt` will be built.
...
The static binary version of DubNextStep is linked against libdb5.3 (see also `this Debian issue`_).
